...
const addToDB = (e) => {
    e.preventDefault(); // Prevent the default form submission
        ...
        const formDataObject = {FirstName:FirstName.value, LastName:LastName.value, Email:Email.value, Phone:Phone.value,Address:Address.value,PostalCode:PostalCode.value};
